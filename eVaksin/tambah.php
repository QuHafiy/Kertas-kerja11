...
<?php
	...
	if (isset($_POST['hantar'])){
		...
		if(mysqli_query($conn, "INSERT INTO maklumat(id_pelajar, nama_pelajar, kelas, jenis_vaksin, tarikh_vaksin) VALUES('$id_pelajar', '$nama_pelajar', '$kelas', '$jenis_vaksin', '$tarikh_vaksin')")){

			echo "<script>alert('Item berjaya ditambah');"."window.location='index.php'</script>";

		}else{

			echo "<script>alert('Item TIDAK berjaya ditambah')</script>";
